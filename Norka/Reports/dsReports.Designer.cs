...
namespace Norka.Reports {
    ...
    public partial class dsReports : global::System.Data.DataSet {
        ...
        public partial class ReportsDataTable : global::System.Data.TypedTableBase<ReportsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ReportsRow AddReportsRow(string Pfad, string Name) {
        ...
        public partial class ReportsRow : global::System.Data.DataRow {
            ...
            public string Pfad {
                get {
                    return ((string)(this[this.tableReports.PfadColumn]));
                }
                set {
                    this[this.tableReports.PfadColumn] = value;
                }
            }
...
namespace Norka.Reports.dsReportsTableAdapters {
    ...
    public partial class ReportsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Reports] WHERE (([ID] = @Original_ID) AND ((@IsNull_Name = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Reports] ([Pfad], [Name]) VALUES (@Pfad, @Name);\r\nSELECT ID, P" +
                "fad, Name FROM Reports WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Reports] SET [Pfad] = @Pfad, [Name] = @Name WHERE (([ID] = @Origina" +
                "l_ID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)));" +
                "\r\nSELECT ID, Pfad, Name FROM Reports WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Pfad, Name FROM dbo.Reports";
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsReports.ReportsDataTable dataTable) {
        ...
        public virtual int Insert(string Pfad, string Name) {
            if ((Pfad == null)) {
                throw new global::System.ArgumentNullException("Pfad");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(Pfad));
            }
            if ((Name == null)) {
        ...
        public virtual int Update(string Pfad, string Name, int Original_ID, string Original_Name, int ID) {
            if ((Pfad == null)) {
                throw new global::System.ArgumentNullException("Pfad");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((string)(Pfad));
            }
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Pfad, string Name, int Original_ID, string Original_Name) {
            return this.Update(Pfad, Name, Original_ID, Original_Name, Original_ID);
        }
    }

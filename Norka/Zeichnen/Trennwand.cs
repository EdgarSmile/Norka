...
namespace Norka.Zeichnen
{
  ...
  public class Trennwand : IPosition
  {
    #region Properties
    ...
    public float AluTrennwand
    {
      get
      {
        return (float)Math.Round(Schildbreite + Aussparungsbreite + Zeichenparameter.TW_Alu,1);
      }
    }
    ...
    public float AluETW
    {
      get
      {
        return (float)Math.Round(Schildbreite + Aussparungsbreite + Zeichenparameter.TW_ETW,1);
      }
    }
    ...
    public string AsString()
    {
      ...
      return
           ...
           "Höhe Aussparung:        " + HöheAussparung + "\n\r" +
            ...
            "Platten:" + "\n\r\n\r" +
            Stk + " x " + PlatteSchildBreite + " / " + PlatteSchildHoehe + "\n\r" +
            Stk + " x " + PlatteAussparungBreite + " / " + PlatteAussparungHöhe + "\n\r\n\r" +
            "Alu:" + "\n\r\n\r" +
            Stk + " x " + AluTrennwand + " (" + AluETW +  ")" + "\n\r" +
